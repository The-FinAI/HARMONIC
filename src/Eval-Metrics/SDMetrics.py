...
if __name__ == "__main__":
    ...
    metadata_info = {"german": {'columns': {'Status of existing checking account': {'sdtype': 'categorical'},
                     ...
                     "buddy": {'columns':{'issue_date': {'sdtype': 'numerical', 'computer_representation': 'Int64'},
                                          'listing_date': {'sdtype': 'numerical', 'computer_representation': 'Int64'},
                                          'condition': {'sdtype': 'categorical'},
                                          'color_type': {'sdtype': 'categorical'},
                                          'length(m)': {'sdtype': 'numerical', 'computer_representation': 'Float32'},
                                          'height(cm)': {'sdtype': 'numerical', 'computer_representation': 'Float32'},
                                          'X1': {'sdtype': 'categorical'},
                                          'X2': {'sdtype': 'categorical'},
                                          'pet_category': {'sdtype': 'categorical'},
                                          'breed_category': {'sdtype': 'categorical'}}},
                     "abalone": {'columns':{'Sex': {'sdtype': 'categorical'},
                                            'Length': {'sdtype': 'numerical', 'computer_representation': 'Float32'},
                                            'Diameter': {'sdtype': 'numerical', 'computer_representation': 'Float32'},
                                            'Height': {'sdtype': 'numerical', 'computer_representation': 'Float32'},
                                            'Whole_weight': {'sdtype': 'numerical', 'computer_representation': 'Float32'},
                                            'Shucked_weight': {'sdtype': 'numerical', 'computer_representation': 'Float32'},
                                            'Viscera_weight': {'sdtype': 'numerical', 'computer_representation': 'Float32'},
                                            'Shell_weight': {'sdtype': 'numerical', 'computer_representation': 'Float32'},
                                            'Class_number_of_rings': {'sdtype': 'numerical', 'computer_representation': 'Int64'}}},
                     "california": {'columns':{'longitude': {'sdtype': 'numerical', 'computer_representation': 'Float32'},
                                               'latitude': {'sdtype': 'numerical', 'computer_representation': 'Float32'},
                                               'housing_median_age': {'sdtype': 'numerical', 'computer_representation': 'Int64'},
                                               'total_rooms': {'sdtype': 'numerical', 'computer_representation': 'Float32'},
                                               'total_bedrooms': {'sdtype': 'numerical', 'computer_representation': 'Float32'},
                                               'population': {'sdtype': 'numerical', 'computer_representation': 'Int64'},
                                               'households': {'sdtype': 'numerical', 'computer_representation': 'Float32'},
                                               'median_income': {'sdtype': 'numerical', 'computer_representation': 'Float32'},
                                               'median_house_value': {'sdtype': 'numerical', 'computer_representation': 'Float32'}}}
                     }
